...
#### *its* vs. *it's*
*Its* is the possessive of *it*: *The monkey played with its tail*. *Its* means "belonging to it." *It's* is a contraction for *it is*: *It's important to know how to cook.* Try reading your writing aloud, saying "it is" when you come across "it's." If you meant "it is," then the contraction "it's" is correct. If you did not mean "it is," you have mistakenly written "it's" when you meant "its" (the possessive of it). 
...
In American usage, double quotation marks start a quotation, and single quotation marks are for material quoted inside that quote: *Jones agrees with this point, adding that "Whenever he had a few too many Red Bulls, I often heard Dr. Doom claim that he was 'sure to vanquish that pesky Spider-Man'" (67).* Also, use double quotations to mark terms being used as terms or for those ironic, sarcastic quotation marks that distance you from the term or material within the quotation marks: *This "innovation" that the consultant touted is not worth the effort.* These uses of double quotation marks have the effect of adding "so-called", e.g., *The "dealer" button in tournament Hold 'Em poker moves to a new player each hand to ensure fair distribution of position-based opportunities and the pre-deal bets known as "blinds," even though the actual dealer remains the non-player dealer employed by the tournament organizers.*
...
#### sentence length
There is no ideal one-size-fits-all sentence length. Adept writers vary the length of their sentences for several reasons, including emphasis, rhythm, and tone. Students sometimes default to writing a series of simple sentences that, over time, sound monontonous. Or they might develop ideas as they write, branching off the sentence into new territory without later editing the sentence to make sure that it focuses on a certain idea or set of ideas. So the two basic ways to go wrong are: monotonous sentences or sprawling sentences. Here is some [good information about sentence length from the AJE (American Journal Editors)](https://www.aje.com/arc/editing-tip-sentence-length/). The advice is written for scholars writing science articles, but applies broadly to the expository writing that you will do in classes I teach. This advice is particularly useful:
...
Find and fix your spacing errors. Usually, Google Docs or MS Word will show spacing errors.
...
#### *try and*
*Try and* should probably be *try to*. While *try and* is an accepted informal and (especially) spoken form of expressing *try to,* you can never go wrong by writing *try to.* Oddly, according to Garner, *try and* is standard in UK usage. But in US academic or legal contexts, stick to *try to.* 

# U
#### *utilize* (vs *use*)
Some people [claim a meaningful distinction between these words](http://throwgrammarfromthetrain.blogspot.com/2013/12/using-utilize-what-mavens-say.html), but I am not convinced. In my view, *use* is almost always preferable to *utilize* because *utilize* is bureaucratic in tone and uses three syllables to do what *use* does in just one. So *use* should be your default choice unless there's a good reason to write *utilize.*
