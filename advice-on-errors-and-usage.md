...
#### ampersand
In the writing thatyou'll do in my classes, spell out the word *and* instead of using the ampersand (&) character. **Exception: use the ampersand if it's part of a company name, e.g., Proctor & Gamble.
#### *analyzation*
